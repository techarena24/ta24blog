  ...
  return (
    <div>
      ...
      <div className=" space-y-6 mb-10">
        <p>
          Tech Arena24 is a Mobile phone tech blog that is owned and managed by
          two brothers. The main aim of Tech Arena24 is to help people make
          choices with regard to buying a phone that suits their needs and meets
          their budget. The long-term goal of Tech Arena24 is to be able to
          build tools that enable other businesses to thrive online. But for
          now, we're focused on online and affiliate marketing.
        </p>
        <p>
        ...
        <div>
          ...
          <div className=" space-y-4">
            <p>
              ...
              Tecno, etc. We can pre-order a new phone for you and you get to be
              among the very first persons to use the phone in the country.
            </p>
            <p>
              All pre-ordered phones will be delivered to the address given to
              us. Here is something interesting for you, we get to buy the phone
              at a very cheap price because we'll be getting it for you at a
              retail price.
            </p>
          </div>
        </div>
        <div>
          ...
          <div>
            <p>
              ...
              Our reviews are unbiased and these reviews will better help you in
              making decisions related to buying any phone.
            </p>
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div>
            <p>
              ...
              our YouTube Channel now to be getting all the live updates as they
              drop.
            </p>
          </div>
        </div>
        <div>
          ...
          <div>
            <p>
              Tech Arena24 is owned and managed by two brothers from South-South
              Nigeria.
            </p>
          </div>
        </div>
