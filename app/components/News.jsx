              ...
              <Link key={post.id} href={`/${post.slug}`}>
                <div className=' flex flex-row w-full p-4 gap-4 sm:min-w-[350px] sm:flex-col shadow-sm rounded-sm overflow-hidden'>
                  <Image 
                    ...
                    height={80} 
                    priority
                    className=' w-20 h-20 rounded-full sm:rounded-sm bg-white object-contain sm:mt-0 sm:ml-0 sm:w-full sm:h-[200px] sm:rounded-t-sm '
                  />
                  <div className=' space-y-2'>
                    ...
                    <p className='  text-sm text-gray-500 line-clamp-3 text-wrap'>{post.content}</p>
